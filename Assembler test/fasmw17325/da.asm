...
proc WindowProc hwnd,wmsg,wparam,lparam
  ...
  update_window:
	...
	jmp	finish
  wmcommand:
    cmp [wparam], BN_CLICKED shl 16 + ID_DA_BUTTON
    je startbutton
    jmp	finish
  startbutton:
    invoke MessageBox,NULL,_error,NULL,MB_ICONERROR+MB_OK
  ...
  wmcreate:							    ;x,y,width,height
	...
	mov	[hwndscroll],eax
	invoke	CreateWindowEx,0,_button, _da,WS_VISIBLE+WS_CHILD,25,75,195,15,[hwnd],ID_DA_BUTTON,[wc.hInstance],NULL
	mov	[hwndstatic],eax
