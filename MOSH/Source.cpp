...
//	string res = "";
//	res += to_string(i.first.first) + sp;
//	res += to_string(i.first.second) + sp;
//	res += to_string(i.second.first) + sp;
//	res += to_string(i.second.second);
//	return res + " ";
//}
...
//	vector<int> no;
//	int pizdets = 0;
//	for (auto i : paths) pizdets += (worst(i.first.first, i.first.second, i.second.first, i.second.second));
//	cout << pizdets  * 10<< endl;
//	//return;
...
//	for (auto i : FUCK) {
//		auto t = i;
//		t.second = t.second / worst(t.first.first.first, t.first.first.second, t.first.second.first, t.first.second.second);
//		FUCK_FUCK.push_back(t);
//		//cout << pstr(i.first) << ":" << i.second;
//	}
...
//
//	//cout << " -- ";
//	for (int i = 0; i < 100 && i < FUCK_FUCK.size(); ++i) cout << pstr2(FUCK_FUCK[i].first) << endl;
//	// << ":" << FUCK_FUCK[i].second << " ";
//
//	vector<vector<vector<int>>> weights(n, vector<vector<int>>(m, vector<int>{0, 0, 0, 0}));
